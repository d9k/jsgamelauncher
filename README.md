...
NOTE: There is [black screen issue](https://github.com/monteslu/jsgamelauncher/issues/74) on some ROCKNIX devices while using `LIBMALI` GPU driver. You can switch driver to `PANFORST` in `Main menu -> System settings -> Performance -> GPU driver`.
